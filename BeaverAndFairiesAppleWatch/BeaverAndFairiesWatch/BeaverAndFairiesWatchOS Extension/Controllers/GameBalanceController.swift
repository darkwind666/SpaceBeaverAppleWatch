...
class GameBalanceController {
    ...
    func setUpBalanceData() {
        ...
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.06, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.06, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.06, distanceBetweeneBlocks: 0.25, taskCount: 1, blocktype: 1, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 3))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 2, blocktype: 1, randomTaskCount: 0, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 1, randomTaskCount: 0, timeInterval: 3))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 1, randomTaskCount: 1, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 0.25, taskCount: 2, blocktype: 0, randomTaskCount: 1, timeInterval: 2))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 2, blocktype: 0, randomTaskCount: 0, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 2, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.06, distanceBetweeneBlocks: 1.3, taskCount: 2, blocktype: 1, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 0.25, taskCount: 1, blocktype: 1, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 3, blocktype: 1, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 2, blocktype: 1, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 3, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.01, distanceBetweeneBlocks: 0.7, taskCount: 3, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 3, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 3, blocktype: 1, randomTaskCount: 0, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.7, taskCount: 2, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 3, blocktype: 0, randomTaskCount: 1, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 3, blocktype: 0, randomTaskCount: 0, timeInterval: 4))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.06, distanceBetweeneBlocks: 0.7, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 4))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 2, blocktype: 0, randomTaskCount: 0, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.7, taskCount: 4, blocktype: 0, randomTaskCount: 1, timeInterval: 4))
        ...
        gameBalaceData.append(GameStageModel(speed: 0.04, distanceBetweeneBlocks: 1.3, taskCount: 2, blocktype: 1, randomTaskCount: 0, timeInterval: 3))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 0.25, taskCount: 1, blocktype: 0, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 5, blocktype: 1, randomTaskCount: 0, timeInterval: 4))
        gameBalaceData.append(GameStageModel(speed: 0.02, distanceBetweeneBlocks: 1.3, taskCount: 5, blocktype: 0, randomTaskCount: 1, timeInterval: 4))
